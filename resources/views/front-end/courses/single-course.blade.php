...
<div class="breadcumb-area">
    ...
    <div class="single-course-intro d-flex align-items-center justify-content-center" style="background-image: url({{URL::to('/')}}/images/{{$course->image}}););">
        <!-- Content -->
        <div class="single-course-intro-content text-center">
            ...
            <div class="meta d-flex align-items-center justify-content-center">
                ...
                <a href="#">{{ucfirst($course->category->name)}}</a>
            </div>
            ...
            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="single-instructor d-flex align-items-center mb-30">
                                                        ...
                                                        <div class="instructor-info">
                                                            <h5>{{ucfirst($instructor->user->full_name)}}</h5>
                                                            <span>Teacher</span>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="course-sidebar">
                        ...
                        <div class="sidebar-widget">
                            <h4>Certification</h4>
                            <img src="{{URL::to('/')}}/images/{{$course->certification->image}}" alt="">
                        </div>
